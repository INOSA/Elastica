...
use Elastica\Query;
use Elastica\Query\AbstractMatch;
...
class QueryTest extends AbstractDSLTest
{
    ...
    public function testMatch()
    {
        ...
        $this->assertInstanceOf(Query\MatchQuery::class, $match);
    }
    ...
    public function testInterface()
    {
        ...
        $this->_assertImplemented($queryDSL, 'has_child', Query\HasChild::class, [new AbstractMatch()]);
        $this->_assertImplemented($queryDSL, 'has_parent', Query\HasParent::class, [new AbstractMatch(), 'type']);
        $this->_assertImplemented($queryDSL, 'ids', Query\Ids::class, [[]]);
        $this->_assertImplemented($queryDSL, 'match', AbstractMatch::class, ['field', 'values']);
